...
var containerXml = `<?xml version="1.0" encoding="utf-8" standalone="no"?>
...
div.example-contents pre.screen {
  margin: 0;
}
...
`
var bookTocTpl = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE html>
<html
  ...
  <body>
    ...
    <nav epub:type="toc" id="toc">
      <h2>Table of Contents</h2>
        <ol> 
      {{range .Chapters}}    <li><a href="{{.ChapterID}}.xhtml">{{.ChapterTitle}}</a></li>
      {{ end }}</ol>
    </nav>
  </body>
</html>
`
var chapterTpl = `<?xml version="1.0" encoding="UTF-8" standalone="no"?>
<!DOCTYPE html>
<html
  xmlns="http://www.w3.org/1999/xhtml"
  xmlns:epub="http://www.idpf.org/2007/ops"
...
{{ range .Chapters }}    <item id="id-{{.ChapterID}}" href="{{.ChapterID}}.xhtml" media-type="application/xhtml+xml"/>
{{ end }}    </manifest>
  <spine>
    <itemref idref="cover" linear="no"/>
    <itemref idref="htmltoc" linear="yes"/> 
{{ range .Chapters }}    <itemref idref="id-{{.ChapterID}}"/>
{{ end }}    </spine>
</package>
`
